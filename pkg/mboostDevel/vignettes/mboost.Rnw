...
%%\VignetteDepends{mboostDevel, party, TH.data}
...
from the \texttt{mboost} vignette\footnote{Accessible via \code{vignette("mboost", package = "mboostDevel")}.}.
...
if (!require("mboostDevel"))
    install.packages("mboostDevel", dependencies = TRUE)
library("mboostDevel")
...
@
<<mboost-fm>>=
library("mboostDevel")               ### attach package `mboost'
